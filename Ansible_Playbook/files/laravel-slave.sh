...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=okaea/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=okaea/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=falcon20/' /var/www/html/laravel/.env
